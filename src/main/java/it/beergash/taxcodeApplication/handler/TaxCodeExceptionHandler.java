package it.beergash.taxcodeApplication.handler;
...
import it.beergash.taxcodeApplication.model.GenericErrorResponse;
...
public class TaxCodeExceptionHandler {
    ...
    /**
     * Handler for exception @{@link CityServiceException}
     * @param
     * @return error message
     */
